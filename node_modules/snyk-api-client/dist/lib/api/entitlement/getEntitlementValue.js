...
exports.default = (function (data, opts) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var orgId, entitlementKey, endpoint, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    orgId = data.orgId, entitlementKey = data.entitlementKey;
                    endpoint = getUrl_1.default.getEntitlementValue(orgId, entitlementKey);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
